...
int burner() {
    static const uint32_t BURNER_MODE = 0x80000000;
    ...
    if (snrt_global_core_idx() == 0) {
        printf("\nStarting program: Burner (Phase1 and Phase2)\n\n");
        ...
        set_simbacore_csr(BURNER_MODE, seqLen, dModel, dInner, dtRank, xProjDim);
    ...
    if (snrt_global_core_idx() == 0) {
        ...
        set_simbacore_csr(BURNER_MODE, seqLen, dModel, dInner, dtRank, dModel);
