...
int main() {
    ...
    if (snrt_global_core_idx() == 0) {
        ...
        set_versacore_streamer_csr(
            ...
            quantization_enable, shift_i, multiplier_i, input_zp_i, output_zp_i, int32tofp16_enable, int4_a_enable,
            int4_b_enable);
        ...
        if (quantization_enable == 0 && int32tofp16_enable == 0)
            err += check_versacore_result_D32((int32_t*)local_d, (int32_t*)D, d_data_length, false);
        else if (quantization_enable == 1 && int32tofp16_enable == 0) {
            err += check_versacore_result_D32((int8_t*)local_d, (int8_t*)D_quantized, d_data_length, false);
        } else if (int32tofp16_enable == 1) {
            err += check_versacore_result_D32((int8_t*)local_d, (int8_t*)D_int32tofp16, d_data_length, false);
        }
